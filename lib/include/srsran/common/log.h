...
public:
  ...
  static srsran::LOG_LEVEL_ENUM get_level_from_string(std::string l)
  {
    std::transform(l.begin(), l.end(), l.begin(), ::toupper);
    if ("NONE" == l) {
      return srsran::LOG_LEVEL_NONE;
    } else if ("ERROR" == l) {
      return srsran::LOG_LEVEL_ERROR;
    } else if ("WARNING" == l) {
      return srsran::LOG_LEVEL_WARNING;
    } else if ("INFO" == l) {
      return srsran::LOG_LEVEL_INFO;
    } else if ("DEBUG" == l) {
      return srsran::LOG_LEVEL_DEBUG;
    } else {
      return srsran::LOG_LEVEL_NONE;
    }
  }
