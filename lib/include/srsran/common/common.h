...
#define pool_allocate (srsran::allocate_unique_buffer(*pool, __PRETTY_FUNCTION__))
#define pool_allocate_blocking (srsran::allocate_unique_buffer(*pool, __PRETTY_FUNCTION__, true))
#define SRSRAN_BUFFER_POOL_LOG_NAME_LEN 128
#else
#define pool_allocate (srsran::allocate_unique_buffer(*pool))
#define pool_allocate_blocking (srsran::allocate_unique_buffer(*pool, true))
#endif
...
public:
  ...
  {
    bzero(buffer, SRSRAN_MAX_BUFFER_SIZE_BYTES);
