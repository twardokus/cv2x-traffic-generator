...
public:
   ...
   */
  virtual bool tx(rf_buffer_interface& buffer, const uint32_t& nof_samples, const srsran_timestamp_t& tx_time) = 0;
   ...
   * @return
   */
  virtual bool rx_now(rf_buffer_interface& buffer, const uint32_t& nof_samples, srsran_timestamp_t* rxd_time) = 0;
  ...
  virtual void              get_time(srsran_timestamp_t* now) = 0;
