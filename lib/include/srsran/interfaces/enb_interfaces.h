...
#include "srsran/asn1/rrc_asn1.h"
...
public:
   ...
   */
  virtual void ho_preparation_complete(uint16_t rnti, bool is_success, srsran::unique_byte_buffer_t container) = 0;
};
...
public:
  ...
  virtual void
               initial_ue(uint16_t rnti, asn1::s1ap::rrc_establishment_cause_e cause, srsran::unique_byte_buffer_t pdu) = 0;
...
class stack_interface_mac_lte : public srsran::task_handler_interface
{};
