...
inline bool gtpu_supported_flags_check(gtpu_header_t* header, srsran::log_ref gtpu_log)
{
  // flags
...
inline bool gtpu_supported_msg_type_check(gtpu_header_t* header, srsran::log_ref gtpu_log)
{
  // msg_tpye
