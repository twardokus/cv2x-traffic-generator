...
{
public:
  pdcp(srsran::task_handler_interface* task_executor_, const char* logname);
  virtual ~pdcp();
  ...
  void enable_integrity(uint32_t lcid, srsran_direction_t direction);
  void enable_encryption(uint32_t lcid, srsran_direction_t direction);
