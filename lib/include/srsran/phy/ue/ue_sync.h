...
SRSRAN_API int srsran_ue_sync_init_file(srsran_ue_sync_t *q,
                                        uint32_t nof_prb,
                                        char *file_name, 
                                        int offset_time, 
                                        float offset_freq);
...
SRSRAN_API void srsran_ue_sync_file_wrap(srsran_ue_sync_t *q,
                                         bool enable);

SRSRAN_API int srsran_ue_sync_set_cell(srsran_ue_sync_t *q,
                                       srsran_cell_t cell);
...
SRSRAN_API void srsran_ue_sync_copy_cfo(srsran_ue_sync_t *q,
                                        srsran_ue_sync_t *src_obj);
...
SRSRAN_API void srsran_ue_sync_set_cfo_ema(srsran_ue_sync_t *q,
                                           float ema);

SRSRAN_API void srsran_ue_sync_set_cfo_ref(srsran_ue_sync_t *q, float res_cfo);

SRSRAN_API void srsran_ue_sync_set_cfo_i_enable(srsran_ue_sync_t *q,
                                                bool enable);

SRSRAN_API void srsran_ue_sync_set_N_id_2(srsran_ue_sync_t *q,
                                          uint32_t N_id_2);
...
SRSRAN_API void srsran_ue_sync_set_sfo_correct_period(srsran_ue_sync_t *q,
                                                      uint32_t nof_subframes);

SRSRAN_API void srsran_ue_sync_set_sfo_ema(srsran_ue_sync_t *q,
                                           float ema_coefficient);

SRSRAN_API void srsran_ue_sync_get_last_timestamp(srsran_ue_sync_t *q,
