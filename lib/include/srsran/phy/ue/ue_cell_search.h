...
SRSRAN_API int srsran_ue_cellsearch_scan_N_id_2(srsran_ue_cellsearch_t *q,
                                                uint32_t N_id_2, 
...
SRSRAN_API int srsran_ue_cellsearch_set_nof_valid_frames(srsran_ue_cellsearch_t *q,
                                                         uint32_t nof_frames);
