...
#define SRSRAN_PUCCH_DEFAULT_THRESHOLD_FORMAT1 (0.2f)
#define SRSRAN_PUCCH_DEFAULT_THRESHOLD_FORMAT1A (0.2f)
#define SRSRAN_PUCCH_DEFAULT_THRESHOLD_FORMAT2 (0.2f)
#define SRSRAN_PUCCH_DEFAULT_THRESHOLD_DMRS (0.2f)

typedef struct {
  srsran_sequence_t seq_f2[SRSRAN_NOF_SF_X_FRAME];
  uint32_t          cell_id;
...
SRSRAN_API int srsran_pucch_set_rnti(srsran_pucch_t* q, uint16_t rnti);

SRSRAN_API void srsran_pucch_free_rnti(srsran_pucch_t* q, uint16_t rnti);
...
SRSRAN_API uint32_t srsran_pucch_n_prb(srsran_cell_t* cell, srsran_pucch_cfg_t* cfg, uint32_t ns);
