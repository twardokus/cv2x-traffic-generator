...
#include "srsran/phy/ch_estimation/ul_rs_tables.h"
...
SRSRAN_API int srsran_refsignal_ul_init(srsran_refsignal_ul_t* q, uint32_t max_prb);

SRSRAN_API int srsran_refsignal_ul_set_cell(srsran_refsignal_ul_t* q, srsran_cell_t cell);

SRSRAN_API void srsran_refsignal_ul_free(srsran_refsignal_ul_t* q);

SRSRAN_API void srsran_refsignal_r_uv_arg_1prb(float* arg, uint32_t u);
...
SRSRAN_API uint32_t srsran_refsignal_get_q(uint32_t u, uint32_t v, uint32_t N_sz);
