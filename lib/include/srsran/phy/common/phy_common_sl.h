...
typedef enum SRSRAN_API {
  SRSRAN_SIDELINK_TM1 = 1,
  SRSRAN_SIDELINK_TM2,
  SRSRAN_SIDELINK_TM3,
  SRSRAN_SIDELINK_TM4
} srsran_sl_tm_t;

#define SRSRAN_SIDELINK_TM1 1
#define SRSRAN_SIDELINK_TM2 2
#define SRSRAN_SIDELINK_TM3 3
#define SRSRAN_SIDELINK_TM4 4
...
SRSRAN_API bool srsran_cell_sl_isvalid(srsran_cell_sl_t* cell);
void srsran_cell_sl_fprint(FILE* stream, srsran_cell_sl_t* cell, uint32_t sfn);
...
SRSRAN_API int srsran_sl_comm_resource_pool_set_cfg(srsran_sl_comm_resource_pool_t* q,
                                                    srsran_cell_sl_t                cell,
