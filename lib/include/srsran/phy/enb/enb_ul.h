...
SRSRAN_API int
srsran_enb_ul_set_cell(srsran_enb_ul_t* q, srsran_cell_t cell, srsran_refsignal_dmrs_pusch_cfg_t* pusch_cfg);

SRSRAN_API int srsran_enb_ul_add_rnti(srsran_enb_ul_t* q, uint16_t rnti);

SRSRAN_API void srsran_enb_ul_rem_rnti(srsran_enb_ul_t* q, uint16_t rnti);
