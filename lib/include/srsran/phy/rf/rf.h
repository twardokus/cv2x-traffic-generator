...
SRSRAN_API double srsran_rf_set_rx_gain(srsran_rf_t* h, double gain);

SRSRAN_API void srsran_rf_set_tx_rx_gain_offset(srsran_rf_t* h, double offset);

SRSRAN_API double srsran_rf_set_rx_gain_th(srsran_rf_t* h, double gain);
...
SRSRAN_API double srsran_rf_set_tx_gain(srsran_rf_t* h, double gain);
