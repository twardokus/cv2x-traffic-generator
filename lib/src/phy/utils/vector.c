...
void srsran_vec_xor_bbb(int8_t* x, int8_t* y, int8_t* z, const uint32_t len)
{
...
{
  return (cf_t*)srsran_vec_malloc((uint32_t)sizeof(cf_t) * nsamples);
}

float* srsran_vec_f_malloc(uint32_t nsamples)
{
  return (float*)srsran_vec_malloc((uint32_t)sizeof(float) * nsamples);
}

int32_t* srsran_vec_i32_malloc(uint32_t nsamples)
{
  return (int32_t*)srsran_vec_malloc((uint32_t)sizeof(int32_t) * nsamples);
}

uint32_t* srsran_vec_u32_malloc(uint32_t nsamples)
{
  return (uint32_t*)srsran_vec_malloc((uint32_t)sizeof(uint32_t) * nsamples);
}

int16_t* srsran_vec_i16_malloc(uint32_t nsamples)
{
  return (int16_t*)srsran_vec_malloc((uint32_t)sizeof(int16_t) * nsamples);
}

uint16_t* srsran_vec_u16_malloc(uint32_t nsamples)
{
  return (uint16_t*)srsran_vec_malloc((uint32_t)sizeof(uint16_t) * nsamples);
}

int8_t* srsran_vec_i8_malloc(uint32_t nsamples)
{
  return (int8_t*)srsran_vec_malloc((uint32_t)sizeof(int8_t) * nsamples);
}

uint8_t* srsran_vec_u8_malloc(uint32_t nsamples)
{
  return (uint8_t*)srsran_vec_malloc((uint32_t)sizeof(uint8_t) * nsamples);
}
