...
int srsran_enb_dl_add_rnti(srsran_enb_dl_t* q, uint16_t rnti)
{
  return srsran_pdsch_set_rnti(&q->pdsch, rnti);
}

void srsran_enb_dl_rem_rnti(srsran_enb_dl_t* q, uint16_t rnti)
{
  srsran_pdsch_free_rnti(&q->pdsch, rnti);
}
