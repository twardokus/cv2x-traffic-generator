...
double srsran_rf_set_rx_gain_th(srsran_rf_t* rf, double gain)
{
...
double srsran_rf_set_rx_gain(srsran_rf_t* rf, double gain)
{
...
double srsran_rf_set_tx_gain(srsran_rf_t* rf, double gain)
{
