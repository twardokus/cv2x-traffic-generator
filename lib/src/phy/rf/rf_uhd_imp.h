...
SRSRAN_API int rf_uhd_start_rx_stream_nsamples(void* h, uint32_t nsamples);
...
SRSRAN_API double rf_uhd_set_rx_gain(void* h, double gain);
...
SRSRAN_API double rf_uhd_set_tx_gain(void* h, double gain);
