...
bool srsran_cell_sl_isvalid(srsran_cell_sl_t* cell)
{
 ...
 *
 * @param q srsran_sl_comm_resource_pool_t object
 * @param cell srsran_cell_sl_t object
 ...
 */
int srsran_sl_comm_resource_pool_set_cfg(srsran_sl_comm_resource_pool_t* q,
